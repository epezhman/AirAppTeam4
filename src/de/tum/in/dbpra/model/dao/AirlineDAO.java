...
public class AirlineDAO extends AbstractDAO {
	...
	public AirlineBean getAirlineByID(AirlineBean airline) throws AirlineNotFoundException, AirportNotFoundException, SQLException {
		...
		try (Connection connection = getConnection();
			...
			try (ResultSet resultSet = preparedStatement.executeQuery();) {
				...
				do {
		        	...
		        	airline.setAirportHub(airportdao.getAirportByID(airport));
	...
	public Boolean addairline(AirlineBean airline) throws SQLException{
		...
		try (Connection connection = getConnection();
			...
			preparedStatement.setString(6,airline.getAirportHub().getAirportId());
